...
const App = () => {
  ...
  const [cash_sales, setCashSales] = useState(value_ts - other_sales_sum);
  const [manualCashSales, setManualCashSales] = useState(false);
  ...
  }, [value_ts, value_pos, value_fp, value_cr, manualCashSales]);
